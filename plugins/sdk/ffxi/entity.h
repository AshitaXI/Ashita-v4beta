...
namespace Ashita::FFXI
{
    ...
    struct entity_t
    {
        ...
        uint8_t         Unknown0008;            // Unknown - Used as a flag of some sort.
        ...
        uint8_t         Unknown0017;            // Unknown [Animation related flag, used with mounts.]
        ...
        uint16_t        Unknown0018;            // Unknown [Assumed emote related, does not appear to be used.]
        ...
        uint32_t        Unknown0019;            // Unknown [Emote related, set and read when an emote is used.]
        ...
        uint8_t         Unknown0020[12];        // Unknown [First 8 bytes are used during events, seems to be checked as warp pointers.]
        ...
        uint16_t        Unknown0021;            // Unknown [Used with the 2nd entity attachment; timer value when a player casts an indi spell.]
        float           ModelSize;              // The entities model size. [Generally -1 as default.]
        float           Unknown0022;            // Unknown [Set from player updates, value is (uint8_t)data * 0.10. Read and used when attacking something and selecting a sub-target to switch to.]
        ...
        uint8_t         Unknown0024;            // Unknown [Forced to 0 when the monstrosity name is set.]
        uint8_t         MonstrosityNameAbbr[24];// The entities monstrosity name abbreviation.
        uint8_t         Unknown0025[3];         // Unknown
        uint8_t         Unknown0026[44];        // Unknown
        uint8_t         Unknown0027[36];        // Unknown
        ...
        uint16_t        Unknown0028;            // Unknown
        uint16_t        Unknown0029;            // Unknown [Set to a target index based on the last action / selection arrow target.]
        uint32_t        Unknown0030;            // Unknown
    };
