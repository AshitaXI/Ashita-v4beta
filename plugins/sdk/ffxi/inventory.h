...
namespace Ashita::FFXI
{
    ...
    struct inventory_t
    {
        ...
        uint32_t            Unknown0001;                                                // Unknown [Used as a value compare, perhaps for recycle, seems to max at 16?]
        ...
        uint32_t            Unknown0003;                                                // Unknown - Updated from incoming 0xC9 packet. (/check)
        uint16_t            Unknown0004;                                                // Unknown - Updated from incoming 0xC9 packet. (/check)
        uint16_t            Unknown0005;                                                // Unknown - Updated from incoming 0xC9 packet. (/check)
        uint32_t            Unknown0006;                                                // Unknown - Incremented when zoning and reconstructing memory.
